...
void main() {
  ...
  // ⚠️ «٦ فأعلى» لا «٦ بالضبط» عمداً: ميزة المرفقات تتطلّب v6، ولا تتعطّل
  //   بإصدار أحدث. والتثبيت على رقم بعينه كان يُفشل هذا الملف عند كل ترقية
  //   لاحقة بلا أن يكون في المرفقات خلل — فيتحوّل الاختبار إلى ضجيج يُعدَّل
  //   آلياً بلا قراءة. **الحارس على الرقم الحالي بالضبط في اختبار أحدث
  //   إصدار** (`schema_v7_test.dart`)، وهو موضعه الصحيح.
  test('⭐ إصدار الـ Schema لا يقلّ عن 6 (المرفقات)', () {
