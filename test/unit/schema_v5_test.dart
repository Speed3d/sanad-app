...
void main() {
  ...
  test('ميزات الإصدار ٥ متاحة — الإصدار لا يقلّ عن ٥', () {
    // كان التأكيد `equals(5)` حرفياً، فكسره كل ترقية لاحقة رغم أن ميزات v5
    // سليمة تماماً. غرض هذا الملف اختبار **ميزات** الإصدار ٥ لا تثبيت رقمه —
    // ورقم الإصدار الحالي يحرسه `schema_v6_test.dart`. (المرحلة ج)
