...
void main() {
  ...
  test('⭐ إصدار الـ Schema ٧ فأعلى', () {
    // 🔄 حُوِّل إلى «٧ فأعلى» عند إصدار v8 — للسبب نفسه المشروح في
    // `schema_v6_test.dart`: ملفُّ إصدارٍ قديم يحرس **ما أضافه ذلك
    // الإصدار**، وتثبيتُ الرقم الحالي وظيفةُ ملفِّ الإصدار الأحدث وحده
    // (`schema_v8_test.dart`). وإلا صار كل إصدار جديد يُسقط اختبارات كل
    // الإصدارات السابقة بلا سبب حقيقي.
