...
{
    public partial class Frm_ExcelImporter : DevExpress.XtraEditors.XtraForm
    {
        
        public Frm_ExcelImporter()
        {
            InitializeComponent();
        ...
        private void ImportData(string excelFilePath, string connectionString)
        {
            try
            {
                ...
                string excelTooColumnName = "Too_"; // حافظ على الشرطة السفلية إذا كانت جزءاً من الاسم الفعلي
                string excelItemTypeColumnName = "Item_Type";
                string excelRecNumColumnName = "Rec_Num";
                string excelCloseSafeColumnName = "CloseSafe";
                // **************************************************************************
                ...
                using (SqlConnection sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlBulkCopy bulkCopy = new SqlBulkCopy(sqlConnection))
                    {
                        ...
                        bulkCopy.DestinationTableName = "Stock_Pull";
                        ...
                        bulkCopy.ColumnMappings.Add(excelTooColumnName, "Too_");
                        bulkCopy.ColumnMappings.Add(excelItemTypeColumnName, "Item_Type");
                        bulkCopy.ColumnMappings.Add(excelRecNumColumnName, "Rec_Num");
                        bulkCopy.ColumnMappings.Add(excelCloseSafeColumnName, "CloseSafe");
                        // **************************************************************************
