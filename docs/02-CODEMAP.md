...
| ~~الجرد القديم~~ | — | ✅ **كُنِس بالكامل** (المرحلة ١٦د — 2026-08-30): ملفان + `FiscalPeriodModel` + ٣ مزوّدات + ~٢٥ دالة + ٧ مسارات. وما استُثني عمداً — دوال ربط المقاولين/الشركاء بالخزائن — **صار حيّاً ومستعمَلاً** 2026-09-01 (ع-٥٥) |
