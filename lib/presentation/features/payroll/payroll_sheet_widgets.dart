...
enum _Col {
  ...
  //   راتب ولم يظهر لي أي شيء عليهما في المسودة.» الأيام كانت تنقص بلا
  //   سبب مكتوب، والمدفوعة تختفي تماماً.
  leave('إجازة', 78),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            // «٥ م» مدفوعة · «٥ غ» بلا راتب · «٣م/٢غ» الاثنتان معاً
            cell(_Col.leave, _leaveLabel(entry)),
            cell(
              _Col.absenceDed,
...
/// تسمية عمود الإجازة — «م» مدفوعة و«غ» بلا راتب
///
/// ⚠️ **رمزان لا كلمتان**: العمود ٧٨ بكسل، و«٥ مدفوعة» تتجاوزه. والمفتاح
///   مكتوب في ذيل الكشف المطبوع، والتفصيل الكامل في بطاقة الموظف.
String _leaveLabel(SalaryPayment e) {
  final parts = <String>[
    if (e.leaveDaysPaid > 0) '${e.leaveDaysPaid} م',
    if (e.leaveDaysUnpaid > 0) '${e.leaveDaysUnpaid} غ',
  ];
