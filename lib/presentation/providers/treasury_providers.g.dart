...
String _$treasuriesByKindHash() => r'3a9a96112c8122b20ab62a7ba37ac609fe06c54d';

/// خزائن حسب النوع — للـ Dropdown في شاشة السندات
///
/// Copied from [treasuriesByKind].
@ProviderFor(treasuriesByKind)
const treasuriesByKindProvider = TreasuriesByKindFamily();

/// خزائن حسب النوع — للـ Dropdown في شاشة السندات
///
/// Copied from [treasuriesByKind].
class TreasuriesByKindFamily extends Family<AsyncValue<List<TreasuryModel>>> {
  /// خزائن حسب النوع — للـ Dropdown في شاشة السندات
  ///
  /// Copied from [treasuriesByKind].
  const TreasuriesByKindFamily();

  /// خزائن حسب النوع — للـ Dropdown في شاشة السندات
  ///
  /// Copied from [treasuriesByKind].
  TreasuriesByKindProvider call(
    String kind,
  ) {
    return TreasuriesByKindProvider(
      kind,
    );
  }

  @override
  TreasuriesByKindProvider getProviderOverride(
    covariant TreasuriesByKindProvider provider,
  ) {
    return call(
      provider.kind,
    );
  ...
  @override
  String? get name => r'treasuriesByKindProvider';
}

/// خزائن حسب النوع — للـ Dropdown في شاشة السندات
///
/// Copied from [treasuriesByKind].
class TreasuriesByKindProvider
    extends AutoDisposeFutureProvider<List<TreasuryModel>> {
  /// خزائن حسب النوع — للـ Dropdown في شاشة السندات
  ///
  /// Copied from [treasuriesByKind].
  TreasuriesByKindProvider(
    String kind,
  ) : this._internal(
          (ref) => treasuriesByKind(
            ref as TreasuriesByKindRef,
            kind,
          ),
          from: treasuriesByKindProvider,
          name: r'treasuriesByKindProvider',
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$treasuriesByKindHash,
          dependencies: TreasuriesByKindFamily._dependencies,
          allTransitiveDependencies:
              TreasuriesByKindFamily._allTransitiveDependencies,
          kind: kind,
        );

  TreasuriesByKindProvider._internal(
    super._createNotifier, {
    required super.name,
    required super.dependencies,
    required super.allTransitiveDependencies,
  ...
  @override
  Override overrideWith(
    FutureOr<List<TreasuryModel>> Function(TreasuriesByKindRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: TreasuriesByKindProvider._internal(
        (ref) => create(ref as TreasuriesByKindRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  @override
  AutoDisposeFutureProviderElement<List<TreasuryModel>> createElement() {
    return _TreasuriesByKindProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is TreasuriesByKindProvider && other.kind == kind;
  }
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin TreasuriesByKindRef on AutoDisposeFutureProviderRef<List<TreasuryModel>> {
  /// The parameter `kind` of this provider.
  String get kind;
}

class _TreasuriesByKindProviderElement
    extends AutoDisposeFutureProviderElement<List<TreasuryModel>>
    with TreasuriesByKindRef {
  _TreasuriesByKindProviderElement(super.provider);

  @override
  String get kind => (origin as TreasuriesByKindProvider).kind;
}
