...
//
// كيفية الاستخدام:
//   CurrencyFormatter.formatIQD(1500000.5)     → '1,500,000.500 د.ع'
//   CurrencyFormatter.formatUSD(1250.75)        → '$1,250.75'
//   CurrencyFormatter.parseAmount('1,500 د.ع') → 1500.0
//   CurrencyFormatter.formatWithSign(+5000)     → '+5,000.000 د.ع'  (أخضر)
//   CurrencyFormatter.formatWithSign(-3000)     → '-3,000.000 د.ع'  (أحمر)
// ─────────────────────────────────────────────────────────────────────────────
...
abstract final class CurrencyFormatter {
  ...
  /// مُنسِّق الدينار العراقي — 3 منازل عشرية مع فواصل الآلاف
  static final _iqd = NumberFormat('#,##0.000');

  /// مُنسِّق الدولار — منزلتان عشريتان مع فواصل الآلاف
